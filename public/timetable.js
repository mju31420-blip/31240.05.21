...
const CAMPUS_BUILDINGS = [
  ...
  { key: '차세대과학관', label: '차세대과학관' },
  { key: '제4공학관', label: '제4공학관' },
  { key: '디자인조형센터', label: '디자인조형센터' },
  { key: '체육문화관', label: '체육문화관' },
  { key: '체육관', label: '체육관' },
  { key: '학군단', label: '학군단' },
  { key: '건축도시설계원', label: '건축도시설계원' },
  { key: '하이브리드구조실험센터', label: '하이브리드구조실험센터' },
  { key: '산업협력관', label: '산업협력관' },
];
...
function populateBuildingSelects() {
  const buildings = [
    ...
    { value: '자연', label: '함박관 (Y9)' },
    { value: '명진당', label: '명진당 (Y3)' },
    { value: '학생', label: '학생복지관 (Y21)' },
    { value: '채플', label: '채플관 (Y22)' },
    { value: '차세대과학관', label: '차세대과학관 (과학·융합)' },
    { value: '제4공학관', label: '제4공학관 (공학)' },
    { value: '디자인조형센터', label: '디자인조형센터 (디자인학부)' },
    { value: '체육문화관', label: '체육문화관 (체육·문화)' },
    { value: '체육관', label: '체육관 (실내 체육)' },
    { value: '학군단', label: '학군단 (ROTC)' },
    { value: '건축도시설계원', label: '건축도시설계원 (건축학부)' },
    { value: '하이브리드구조실험센터', label: '하이브리드구조실험센터 (구조 실험)' },
    { value: '산업협력관', label: '산업협력관 (산학협력)' },
  ];
